...
export default {
  ...
  vtpsFormat: {
    ...
    temporalResolution: 5 * 60, // in seconds (this is the resolution found in data files)
    numHeaderLines: 4
  },

  appTemporalResolution: 10 * 60, // seconds (this is the resolution we use for calculation and display) Should be a multiple of vtpsFormat.temporalResolution
